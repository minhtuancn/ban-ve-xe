...
<div style="width:100%;height:40px;background:#145CA1;font-size:30px;color:white;margin-top:10px;">Tìm vé</div>
<div>
...
<td class="tr1" align="center"><input type="submit" value="chọn" class="chon"/></td>
</tr>
<tr id="dong2">
<td class="tr1" align="center">HCM - Nha Trang</td>
