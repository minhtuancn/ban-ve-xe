		...
		<fieldset>
			<div id="gt">
				...
				<p>
					...
					sách khách hàng. - Thống kê doanh thu đạt được trong ngày,
					tháng.... - Chức năng quản lý thu & chi. - Có thể tùy chỉnh phôi in
					ra phù hợp với phôi hiện tại của nhà xe.
				</p>
				<p class="note">
				...
				<p>
					...
					giao thông được sử dụng phổ biến nhất và đáp ứng được nhu cầu của
					đa số người dân, lại chưa có một kênh đặt vé trực tuyến đúng
					...
					trình, địa chỉ, số điện thoại và đánh giá của trên 3000 tuyến đường
					cả nước.
				</p>
				<p class="note">
				...
				<p>
					...
					ngày. VeXeOnline mong muốn được biết đến với tư cách là một công ty
					công nghệ hàng đầu Châu Á chuyên cung cấp các sản phẩm và dịch vụ
					giải quyết các vấn đề hiện tại của xã hội.
				...
				<p>
					...
					* Bộ phận Chăm sóc khách hàng: 08.35 11 77 88<br> * Đường dây
					nóng: 0985 29 29 29<br> * Địa chỉ phòng vé:<br> VP Cẩm
					Tú, khu phố 6, phường Linh Trung, Q.Thủ Đức, TP. Hồ Chí Minh, Việt
					Nam<br>
				</p>
			</div>
			</fieldset>
