...
<body style="color:blue;">
	...
	<div id=contain>
		...
		<div id="center" style="width: 1000px; margin-left: 150px;padding:50px;">
			...
			<fieldset>
				...
				<div style="width: 100%;height: auto;float: left;clear: none;margin-bottom: 20px;">
					<div style="float: left; clear: right;">
						<div class="ktve-dong kt-ve">
							<label class="wd-110 ">Mã vé:</label> <input value="<%=ve.getMaVe() %>"
								class="input-txt wd-240" name="name" type="text" readonly>
						</div>
						<div class="ktve-dong kt-ve">
							<label class="wd-110 ">Tuyến:</label> <input value="<%=ve.getTuyenXe() %>"
								class="input-txt wd-240" readonly name="email" type="text">
						</div>
						<div class="ktve-dong kt-ve">
							<label class="wd-110 ">Ngày khởi hành</label> <input value="<%=ve.getNgayKhoiHanh() %>"
								class="input-txt wd-240" readonly name="sdt" type="text">
						</div>
						<div class="ktve-dong kt-ve">
							<label class="wd-110 ">Bến xuất phát:</label> <input value="<%=ve.getBenXuatPhat() %>"
					...
					<div style="float: left; clear: none; margin-left: 200px;">
						<div class="ktve-dong kt-ve">
							<label class="wd-110 fl-l">Mã ghế:</label> <input value="<%=ve.getTenGhe() %>"
								class="input-txt wd-240" readonly name="email" type="text">
						</div>
						<div class="ktve-dong kt-ve">
							<label class="wd-110">Số lượng ghế:</label> <input value="<%=ve.getSoLuongGhe() %>"
								class="input-txt wd-240" name="name" type="text" readonly>
						</div>
						<div class="ktve-dong kt-ve">
							<label class="wd-110 fl-l">Giá vé:</label> <input value="<%=ve.getGia() %>"
								class="input-txt wd-240" readonly name="sdt" type="text">
						</div>
						<div class="ktve-dong kt-ve">
							<label class="wd-110 fl-l">Tổng tiền:</label> <input value="<%=ve.getTongTien() %>"
								class="input-txt wd-240" name="cmnd" type="text" readonly>
						</div>
					</div>
				</div>
			...
			<input type="hidden" name="maVeThanhToan" value="<%=ve.getMaVe()%>">
				<div style="margin-top: 20px;">
					<div style="float: left; clear: right;">
						<div class="ktve-dong kt-ve">
							<label class="wd-110 fl-l">Số dư tài khoản:</label> <input value="<%= ((KhachHangThuongXuyen)khachHangTT).getSoTien() %>"
					...
					<div style="float: left; margin-left: 200px;">
						<div class="ktve-dong kt-ve">
							<label class="wd-110 fl-l">Số tiền chi trả:</label> <input value="<%=ve.getTongTien() %>" readonly="readonly"
