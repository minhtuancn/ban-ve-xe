...
public class ReadMessages
{
	public void doIt() throws Exception
	{
		...
		try
		{
			...
			SerialModemGateway gateway = new SerialModemGateway("modem.com4", "COM15", 115200, "Huawei", "E160");
...
//				System.out.println(msg);
	...
	public class InboundNotification implements IInboundMessageNotification
	{
		public void process(AGateway gateway, MessageTypes msgType, InboundMessage msg)
		{
			...
			try {
				InboundMessage[] arr = Service.getInstance().readMessages(MessageClasses.ALL);
				Service.getInstance().deleteMessage(msg);
				for (int i = 0; i < arr.length; i++) {
					System.out.println(msg.getOriginator() + " : " + msg.getText());
					OutboundMessage msgOut = new OutboundMessage("+" + msg.getOriginator(), "Sever: " + msg.getText());
					 Service.getInstance().queueMessage(msgOut);
//					System.out.println(msg);
				}
